...
var igoogle = function (query, start, callback) {
  ...
  if (google.timeSpan && google.lr) {
    URL = URL.concat('&tbs=qdr:', google.timeSpan,
                     ',lr:lang_1', google.lr, '&lr=lang_', google.lr)
  } else if (google.timeSpan) {
    URL =  URL.concat('&tbs=qdr:', google.timeSpan)
  } else if (google.lr) {
    URL =  URL.concat('&tbs=lr:lang_1', google.lr, '&lr=lang_', google.lr)
  }
